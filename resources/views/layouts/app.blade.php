...
<body class="theme-light tw-bg-page">
    <div id="app">
                ...
                <div class="tw-flex tw-justify-between tw-items-center tw-py-2">
                    <h1>
                        <a class="navbar-brand" href="{{ url('/projects') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="291" height="45" viewBox="0 0 291 45" class="tw-relative tw-text-default" style="top: 2px;">
                                <g fill="none" fill-rule="evenodd">
                                    <g class="tw-fill-current">
                    ...
                    <div>
                        ...
                        <div class="tw-flex tw-items-center tw-ml-auto">
                            ...
                            <li class="nav-item dropdown tw-list-none">
